...
---
1 - ToothGrowth data and basic exploratory data analyses
...
3 - Confidence intervals and/or hypothesis tests
...
From this analysis, that we can conclude:
 - OJ supplement shows higher tooth growth at dose 0.5 and 1.0 than VC.
 - Both OJ and VC follows same growth pattern at dose 2.0. 
 - OJ shows a higher growth rate even with lower dosage.
 - At high dose, the rate of tooth growth is not statistically different between supplement methods. 
Regardless of the supplement method, dosage is key factor in tooth growth.


The report including the code for plots. Please refer this link https://github.com/chepakrul/stat_inference
